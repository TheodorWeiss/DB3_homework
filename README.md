...
Перед выполнением основного запроса была сделана короткая проверка данных: я посмотрел распределение заказов по брендам, сферам, статусам и типам заказов. 
